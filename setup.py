...
setup(
    ...
    # project.
    author="Carolina Chung",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="chechung@umich.edu",  # Optional
    ...
    #
    packages=find_packages(where="indigopy"),  # Required
    ...
    install_requires=["sphinx, sphinx-rtd-theme, nbsphinx, numpy, pandas, tqdm"],  # Optional
    ...
    project_urls={  # Optional
        ...
        "More Info": "https://systemsbiologylab.org/", 
    },
)
